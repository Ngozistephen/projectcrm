            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="{{route('dashboard.clients.index')}}">Home</a></li>
                ...
                <div class="col-md-12">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            ...
                            <form  method="post" action="{{route('dashboard.clients.store')}}" id="createPorfolioForm" enctype="multipart/form-data">
                                    <div class="form-row" style="margin-bottom: 30px">
                                        <div class="col-md-6">
                                            <input  name="contact_name" class="form-control" placeholder="Contact Name">
                                        </div>
                                        <div class="col-md-6">
                                            <input  name="contact_email" class="form-control" placeholder="Company Email">
                                        </div>
                                    </div>
                                    <div class="form-row" style="margin-bottom: 30px">
                                        <div class="col-md-6">
                                            <input  name="contact_phone_number" class="form-control" placeholder="Phone Number">
                                        </div>
                ...
                <div class="card card-primary">
                  ...
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="text" id="contact_name" name="contact_name" class="form-control" value="{{ old('contact_name', $client->contact_name) }}" required>
                    </div>
                    <div class="form-group">
                      <label class="required" for="contact_email">Email</label>
                      <input type="text" id="contact_email" name="contact_email" class="form-control" value="{{ old('contact_email', $client->contact_email) }}" required>
                    </div>
                    <div class="form-group">
                      <label class="required" for="contact_phone_number">Phone Number</label>
                      <input type="text" id="contact_phone_number" name="contact_phone_number" class="form-control" value="{{ old('contact_phone_number', $client->contact_phone_number) }}" required>
                    </div>
                ...
                <div class="card card-secondary">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" id="company_address" name="company_address" class="form-control" value="{{ old('company_address', $client->company_address) }}" required>
                    </div>
                    <div class="form-group">
                      <label class="required" for="company_city">Company City</label>
                      <input type="text" id="company_city" name="company_city" class="form-control" value="{{ old('company_city', $client->company_city) }}" required>
                    </div>
                    <div class="form-group">
                      <label class="required" for="company_zip">Company Zip</label>
                      <input type="text" id="company_zip" name="company_zip" class="form-control" value="{{ old('company_zip', $client->company_zip) }}" required>
                    </div>
